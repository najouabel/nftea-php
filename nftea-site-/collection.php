...
?>
    ...
    <div class="globalsection"></div>
    
        <img class="imgcover" src="./user/img/smoke3.jpg" alt="">
    
    <div class="div-collection">
        <h2>Découvrez Collectibles</h2>
        <p>Scarce digital property is cropping up in all kinds of industries around the world,
            and nftea is on a mission to house internet goods from all corners of the ecosystem.
            Own, buy, and sell rare and exclusive NFTs from CryptoKitties, Axie Infinity, and beyond.
            Scarce digital property is cropping up in all kinds of industries around the world, 
            and NFTea is on a mission to house internet goods from all corners of the ecosystem. Own,
            buy, and sell rare and exclusive NFTs from CryptoKitties, Axie Infinity, and beyond.</p>
    </div>
    ...
    <div class="container-fluid mt-5">
        <div class="row">
            ...
            <?php if(isset($_GET['msg']) && $_GET['msg']=='added'): ?>
                        ...
                        <a  href="listcoll.php" class="close" data-dismiss="alert">&times;</a>
                        </div>
                <?php endif; ?>
